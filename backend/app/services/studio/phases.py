...
PHASES: tuple[Phase, ...] = (
    ...
    Phase(
        "trends",
        "トレンド分析",
        "蓄積したトレンドデータとWeb調査から、ジャンルの傾向と差別化の余地を整理します",
        1.5,
        skippable=True,
    ),
    Phase(
        "direction",
        "編集方針決定",
        "ジャンル・編集スタイル・テンポ・構成・字幕・フォント・切り替え・BGM・色味を先に決めます",
        1.5,
    ),
    ...
    Phase(
        "audio",
        "BGM / SFX",
        "ライブラリからライセンス確認済みのBGMと効果音を選び、ビートにカットを合わせます",
        2.0,
        skippable=True,
    ),
    ...
    Phase(
        "review",
        "完成動画レビュー",
        "書き出したMP4を実際に解析し、Hook・テンポ・映像・字幕・音・構成・トレンド適合を採点します",
        2.0,
    ),
    Phase(
        "refine",
        "自動改善ループ",
        "レビューの指摘を反映して作り直し、良くなった版を採用します",
        5.0,
        skippable=True,
    ),
